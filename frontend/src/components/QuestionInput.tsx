    ...
    <div className="w-full max-w-2xl">
      <form onSubmit={handleSubmit} className="flex gap-2 sm:gap-3">
        <input
          ...
          disabled={isLoading}
          className="flex-1 h-11 sm:h-12 md:h-16 lg:h-20 px-4 sm:px-5 md:px-8 lg:px-10 rounded-full border-2 border-[#2b1d1a] bg-[#fffcf0]/95 backdrop-blur-sm text-[#2b1d1a] placeholder-amber-700/60 focus:outline-none focus:ring-2 focus:ring-[#2b1d1a] shadow-2xl text-sm sm:text-base md:text-lg lg:text-xl font-medium"
        />
        <button
          type="submit"
